                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="row">
                                <label for="example-text-input" class="col-md-5 col-form-label">No Tagihan / No Pelanggan</label>
                            </div>
                            <div class="mb-3 row">
                                
                                <div class="col-md-10">
                                    <select class="form-control select2" name="id_tagihan_pemasangan" id="id_tagihan_pemasangan" required>
                                        <option value="">-- Pilih Tagihan --</option>
                                        @foreach ($tagihan_pemasangans as $tagihan_pemasangan)
                                            <option value="{{ $tagihan_pemasangan->id }}" @if($request->get('id') == $tagihan_pemasangan->id) selected @endif >{{ $tagihan_pemasangan->id_tagihan_pemasangan }} - {{ $tagihan_pemasangan->pelanggan->id_pelanggan }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="row">
                                <label for="tipe" class="col-md-4 col-form-label" >Tipe Pembayaran</label>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="number" name="jumlah_pembayaran" id="jumlah_pembayaran">
                                </div>
                            </div>
...
@include('pembayaran_pemasangan.js')
