            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route($route.'.store') }}" method='POST'>
                        @csrf
                    <div class="mb-3 row">
                        <label for="name" class="col-md-2 col-form-label">Nama Daerah</label>
                    </div>
                    <div class="mb-3 row">
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="nama_daerah" id="nama_daerah">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <label for="name" class="col-md-2 col-form-label">Konfirmasi Password</label>
                    </div>
                    <div class="mb-3 row">
                        <div class="col-md-10">
